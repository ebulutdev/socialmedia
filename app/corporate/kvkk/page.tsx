    ...
    <div className="bg-dark-card rounded-xl p-4 sm:p-6 lg:p-8">
                ...
                <div className="space-y-6 sm:space-y-8">
                  ...
                  <section>
                    ...
                    <p className="text-gray-300 text-sm sm:text-base leading-relaxed mt-4">
                      Yukarıda belirtilen haklarınızı kullanmak için kimliğinizi tespit edici gerekli bilgiler ve talep olunan diğer bilgiler ile KVK Kanunu'nun 11. maddesinde belirtilen haklardan kullanmayı talep ettiğiniz hakkınıza yönelik açıklamalarınızı içeren talebinizi <strong className="text-primary-green">subjective@gmail.com</strong> adresine iletebilirsiniz.
                    </p>
                  </section>
                </div>
    </div>
