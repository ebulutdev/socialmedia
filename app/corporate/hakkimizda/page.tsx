  ...
  return (
    <div className="bg-dark-card rounded-xl p-4 sm:p-6 lg:p-8">
      ...
      <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
        ...
        <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white">Biz Kimiz?</h1>
      </div>
      ...
      <div className="mb-6 sm:mb-8">
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
              Instagram, TikTok, YouTube, X (Twitter), Facebook gibi tüm popüler sosyal medya platformları için özel hizmetler sunuyoruz. Takipçi artırmadan video izlenmelerine kadar her ihtiyaca uygun çözümler geliştiriyoruz.
            </p>
          </div>
          <div>
            <h3 className="text-lg sm:text-xl font-semibold text-primary-green mb-2">Tamamen Güvenli ve Şifresiz Hizmet</h3>
            <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
              Hiçbir kişisel bilgi talep etmeden, tamamen şifresiz hizmet sunuyoruz. Gizliliğinize ve güvenliğinize en az sizin kadar önem veriyoruz.
            </p>
          </div>
          <div>
            <h3 className="text-lg sm:text-xl font-semibold text-primary-green mb-2">Hızlı Teslimat ve Gerçek Sonuçlar</h3>
            <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
              Siparişlerinizi anında işleme alıyoruz. En kısa sürede, organik ve etkili sonuçlar elde etmenizi sağlıyoruz.
            </p>
          </div>
          <div>
            <h3 className="text-lg sm:text-xl font-semibold text-primary-green mb-2">Müşteri Odaklı Destek Sistemi</h3>
            <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
              Haftanın 7 günü, günün 24 saati aktif olan destek ekibimiz sayesinde her an yanınızdayız. Sorularınızı ve taleplerinizi en hızlı şekilde çözüme kavuşturuyoruz.
            </p>
          </div>
          <div>
            <h3 className="text-lg sm:text-xl font-semibold text-primary-green mb-2">Yüksek Müşteri Memnuniyeti</h3>
            <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
              Binlerce memnun müşteri ile sektörün en güvenilir platformlarından biriyiz. Aldığınız hizmet sonrası memnuniyet garantisi sunuyoruz.
            </p>
          </div>
        </div>
      </div>
