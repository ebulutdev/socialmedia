    ...
    <div className="bg-dark-card rounded-xl p-4 sm:p-6 lg:p-8">
                ...
                <div className="space-y-6 sm:space-y-8">
                  ...
                  <section>
                    ...
                    <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
                      İade talebi için kullanıcı, <strong className="text-primary-green">subjecctive@gmail.com</strong> adresine e-posta göndermelidir. Talep en geç 3 iş günü içinde değerlendirilir ve uygun görülmesi halinde, ödeme yapılan yöntemle 5 iş günü içerisinde iade gerçekleştirilir.
                    </p>
                  </section>
